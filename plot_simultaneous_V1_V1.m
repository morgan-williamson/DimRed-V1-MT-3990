    ...
    for ani = {'CJ177','CJ179','CJ190','CJ191'}% tracks which animal 
        ...
        for p = pens
            ...
            for o = 1:12 % loops through the 12 different directions of stimulus presentation 
                ...
                y4 = 1 - mean(ridgePlots_V1(1,:),2);
                e4 = mean(ridgePlots_V1(2,:),2); 
                x4 = 1.5;
                ...
                y5 = 1 - mean(cvPlots_V1(1,:,:),3);
                e5 = mean(cvPlots_V1(2,:,:),3);
                ...
                y6 = 1 - mean(ridgePlots_V1(1,:),2);
                e6 = mean(ridgePlots_V1(2,:),2); 
                x6 = 0.5;
